...
function loadgraphBarHours(){
    // Définition des marges et dimensions du graphique
    var margin = {top: 30, right: 30, bottom: 70, left: 60},
        width = 460 - margin.left - margin.right,
        height = 400 - margin.top - margin.bottom;

    // Attacher le svg à la div #dataVizHours
    var svg = d3.select("#dataVizHours")
    .append("svg")
    ...
    // Parsing des données
    d3.csv("../datasets/modification-count-by-hours.csv", function(data) {
